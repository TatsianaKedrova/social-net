...
import {getProfileTC, setUserProfile, UserProfileType} from "../../redux/profile-reducer";
...
export default connect(mapStateToProps, {setUserProfile, getProfileTC})(WithRouterDataContainerComponent);